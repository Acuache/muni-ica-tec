 ...
 *
 *   node presentacion/construir.mjs
 */
...
const plantilla = join(DIR, 'plantilla.html')
const salida = join(DIR, 'presentacion.html')
...
console.log(`✅ presentacion.html generado`)
...
console.log(`   ubicación:            presentacion/presentacion.html`)
