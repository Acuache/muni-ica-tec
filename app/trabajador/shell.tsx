...
export default function TrabajadorShell({ username, children }: Props) {
  ...
  const enPerfil = pathname === '/trabajador/perfil'
  ...
  return (
    <div className="flex min-h-full flex-col bg-gray-50">
      ...
      <nav className="flex border-t border-gray-200 bg-white">
        <NavTab href="/trabajador" label="Inicio" Icon={IconHome} active={!enPerfil} />
        <NavTab href="/trabajador/perfil" label="Perfil" Icon={IconUser} active={enPerfil} />
      </nav>
    </div>
  )
}
